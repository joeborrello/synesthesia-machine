...
void setup() {
  ...
  arduino = new Arduino(this, Arduino.list()[0], 57600); //apparently sometimes this needs to be Arduino.list()[0] instead of Arduino.list()[1]
  
  song = minim.loadFile("Mr-Scruff_Get-On-Down.mp3", 2048);
  song.play();
